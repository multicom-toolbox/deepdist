...
if __name__ == '__main__':
    ...
    download_metaclust50(db_tools_dir,metaclust50_info,metaclust50_dir)

    #### Download ebi_uniref100
    print("Download ebi_uniref100\n");
    download_ebi_uniref100(db_tools_dir,ebi_uniref100_info,ebi_uniref100_dir)

    #### Download uniclust30_2017_10
    if os.path.exists(install_dir+"/"+hhsuitedb_info+"_hhsuite.done"):
        print(install_dir+"/"+hhsuitedb_info+"_hhsuite installed....skip")
    else:
        ...
        print(install_dir+"/"+hhsuitedb_info+"_hhsuite installed")
        os.chdir(db_tools_dir)
    ...
    if os.path.exists(install_dir+"/hhsuite-2.0.16-linux-x86_64.done"):
        print(install_dir+"/hhsuite-2.0.16-linux-x86_64 installed....skip")
    else:
        os.system("touch "+install_dir+"/hhsuite-2.0.16-linux-x86_64.running")
        ...
        os.system("mv "+install_dir+"/hhsuite-2.0.16-linux-x86_64.running "+install_dir+"/hhsuite-2.0.16-linux-x86_64.done")
        print(install_dir+"/hhsuite-2.0.16-linux-x86_64 installed")

    if os.path.exists(install_dir+"/hhsuite-3.0-beta.3.done"):
        print(install_dir+"/hhsuite-3.0-beta.3 installed....skip")
    else:
    ...
    #### Download DeepMSA
    if os.path.exists(install_dir+"/DeepMSA.done"):
        print(install_dir+"/DeepMSA installed....skip")
    else:
